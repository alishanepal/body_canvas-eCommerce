...
<div class="page">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
	                	...
	                	<?php else: 
                         $amount =   $final_total;
                         $tax_amount = "0"; // Sample tax amount, you can fetch this from the specifications if needed
                         $total_amount = $amount + $tax_amount; // Calculating total amount
                         $transaction_uuid = uuidv4();
                         $product_code = "EPAYTEST";
                         $product_service_charge = "0";
                         $product_delivery_charge = "0";
                         $success_url = "https://esewa.com.np"; // Redirect URL after successful payment
 ...
 <input value="pay via esewa" class="btn btn-primary" type="submit">
 </form>
